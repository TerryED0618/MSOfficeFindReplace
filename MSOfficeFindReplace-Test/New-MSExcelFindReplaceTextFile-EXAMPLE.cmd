...
START PowerShell -NoLogo -ExecutionPolicy RemoteSigned -NoProfile -Command "<#%stamp%#> Import-Module -Name MSOfficeFindReplace; New-MSExcelFindReplaceTextFile -Path .\New-MSExcelFindReplaceTextFile-EXAMPLE.xlsx -FindReplacePath .\New-MSOfficeFindReplace-EXAMPLE.csv -ExecutionSource TEST