...
START PowerShell -NoLogo -ExecutionPolicy RemoteSigned -NoProfile -Command "<#%stamp%#> Import-Module -Name MSOfficeFindReplace; New-MSWordFindReplaceTextFile -Path .\New-MSWordFindReplaceTextFile-EXAMPLE.docx -FindReplacePath .\New-MSWordFindReplaceTextFile-EXAMPLE.csv -ExecutionSource TEST