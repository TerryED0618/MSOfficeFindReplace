...
START PowerShell -NoLogo -ExecutionPolicy RemoteSigned -NoProfile -Command "<#%stamp%#> Import-Module -Name MSOfficeFindReplace; New-MSOutlookFindReplaceTextFile -Path .\New-MSOutlookFindReplaceTextFile-EXAMPLE.msg -FindReplacePath .\New-MSOfficeFindReplace-EXAMPLE.csv -SaveToDrafts -ExecutionSource TEST